...
if (
    ...
    print("🚫" * 15)
    print("You attempted to run Thom on behalf of root user")
...
def restart():
    if "THOM_DO_NOT_RESTART" in os.environ:
    ...
    os.environ["THOM_DO_NOT_RESTART"] = "1"
...
if sys.version_info < (3, 8, 0):
...
elif __package__ != "thom":  # In case they did python __main__.py
    ...
    if __name__ == "__main__":
        if "THOM_DO_NOT_RESTART" in os.environ:
            del os.environ["THOM_DO_NOT_RESTART"]

        main.thom.main()  # Execute main function

...
class HerokuMod(loader.Module):
    """Stuff related to Thom Heroku installation"""
    ...
    strings_ru = {
        "redisdocs": (
            ...
            " </b><code>heroku-redis</code><b> в Thom app Heroku. Для этого тебе нужно"
    ...
    async def client_ready(self):
        ...
        self._heroku_url = heroku.get_app(api_token=main.thom.api_token)[0].web_url

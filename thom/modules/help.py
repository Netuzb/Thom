...
class HelpMod(loader.Module):
    ...
    strings = {
        ...
        "support": (
            "{} <b>Link to </b><a href='https://t.me/thom_talks'>support chat</a>"
        ),
        "partial_load": (
        ...
        "request_join": "You requested link for Thom support chat",
    }
    ...
    strings_ru = {
        ...
        "support": (
            "{} <b>Ссылка на </b><a href='https://t.me/thom_talks'>чат помощи</a>"
        ),
        ...
        "request_join": "Вы запросили ссылку на чат помощи Thom",
    }
    ...
    @loader.command(ru_doc="Показать ссылку на чат помощи Thom")
    async def support(self, message):
        """Get link of Thom support chat"""
        if message.out:
            await self.request_join("@thom_talks", self.strings("request_join"))
        ...
        await utils.answer(
            ...
            self.strings("support").format(
                ...
                if self._client.thom_me.premium
                else "🌘",
            ),
        )

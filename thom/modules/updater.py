...
class UpdaterMod(loader.Module):
    ...
    strings = {
        ...
        "update_confirm": (
            "❓ <b>Are you sure you"
            " want to update?\n\n<a"
            ' href="https://github.com/Netuzb/Thom/commit/{}">{}</a> ⤑ <a'
            ' href="https://github.com/Netuzb/Thom/commit/{}">{}</a></b>'
        ),
    ...
    async def restart_common(
        ...
        if "DYNO" in os.environ:
            app = heroku.get_app(api_token=main.thom.api_token)[0]
            app.restart()
            return

        with contextlib.suppress(Exception):
            await main.thom.web.stop()
    ...
    async def _add_folder(self):
        ...
        if any(getattr(folder, "title", None) == "thom" for folder in folders):
            return
        ...
        try:
            ...
            logger.critical(
                "Can't create Thom folder. Possible reasons are:\n"
